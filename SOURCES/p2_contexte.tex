\chapter{Description du projet}
    ...
    \section{Cahier des charges  \guy{Arnaud pour rédaction}}
        ...
        \subsection{Collecte de traces}
            ...
            % Rajouter liste des questions auxquelles on doit répondre 
            %  Essayer de les trier ou regrouper en catégories
            %  Essayer de rajouter des images pour rendre plus digeste
        ...
        \subsection{Analyse des traces}
            % Spécifier que analyse statistique c’est si on a le temps et ça va être compliqué  /
            ...
            % Rajouter partie sur exportation des données ou mise en forme des données /
