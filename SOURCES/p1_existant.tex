...
\begin{center}
\includegraphics[scale=0.88]{questionnaire.png}
\captionof{figure}{Gestion des questions}
\label{questionnaire}
\end{center}
...
\begin{center}
\includegraphics[scale=0.88]{bilan.png}
\captionof{figure}{Bilan financier}
...
\begin{center}
\includegraphics[width=0.9\textwidth]{menus_animateur_2.png}
\captionof{figure}{Menus de l'animateur}
\label{menus_animateur}
\end{center}

\begin{center}
\includegraphics[width=0.9\textwidth]{menus_joueur2.png}
\end{center}

\begin{center}
\includegraphics[width=0.2\textwidth]{menus_joueur3.png}
\captionof{figure}{Menus du joueur}
\label{menus_joueur}
\end{center}